...
description: Optimize Three.js UI performance, reduce GPU load, suggest fallback UI strategies, and maintain 60fps experience. Use when Three.js / React Three Fiber scenes drop below 60fps, GPU usage is high, draw calls are excessive, or you need WebGL fallback strategies.
version: 1.0.0
