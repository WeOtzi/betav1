// ============================================
// WE OTZI - Archived Quotations Admin Panel
...
// ============================================
// DATA LOADING - ARCHIVED QUOTATIONS
// ============================================
...
function handleDragStart(e) { this.classList.add('dragging'); dragSrcIndex = this.dataset.index; e.dataTransfer.effectAllowed = 'move'; }
