...
const EVENTS = {
    ...
    request_rating: {
        name: 'Cliente: solicitar calificacion',
        templateHint: 'request-rating',
        recipient: p => p.client_email,
        attribs: p => ({ ...p })
    },
    ...
    job_board_request_created: {
        ...
        templateHint: 'job-board-confirmed',
    ...
    ambassador_status_updated: {
        name: 'Artista: estado embajador actualizado',
        templateHint: 'ambassador-updated',
        recipient: p => p.artist_email || p.email,
        attribs: p => ({ ...p })
    },
    ...
    // ===== Admin / product =====
    platform_update: {
        name: 'Producto: actualizacion de plataforma',
        templateHint: 'platform-update',
        recipient: p => p.recipient_email || p.email,
        attribs: p => ({ ...p })
    },
